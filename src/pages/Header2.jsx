        ...
        <>
            ...
            <header className='relative bg-white'>
                ...
                <nav>
                    ...
                    <div className='header2 w-[100%] hidden xl:flex items-center justify-between py-[25px] px-[65px]'>
                        <Link to='/'>
                            <img className='max-h-[36px]' src={logo} alt="" />
                        </Link>
                        <div className='flex items-center justify-between gap-[70px] text-black font-[600]'>
                            <div className="lang-switcher text-[#BEBEBE] text-[12px]">
                                <Link className='border-[1px] border-[#BEBEBE] rounded-l-[5px] p-[4px]'>EN</Link>
                                <Link className='border-[1px] border-[#BEBEBE] rounded-r-[5px] p-[4px]'>RU</Link>
                            </div>
                        ...
                        <div className='relative flex items-center justify-between gap-[20px] text-[#BEBEBE] text-[22px]'>
                            <FaRegHeart />
                            <IoSearch />
                            <IoIosCart />
                            <div className='dropWrapper'>
                                ...
                                <ul className={`authDrop ${userDrop ? 'flex' : 'hidden'} absolute z-10 top-[60px] right-0 bg-[#fff] text-[20px] text-black font-[600] py-[20px] px-[15px] flex-col gap-[15px] rounded-[10px] text-nowrap`}>
                                    <li className='font-[600] font-sans text-zinc-600'>{user && user.email}</li>
                                    <hr />
                                    <li onClick={() => setUserDrop(false)}><Link to='profile'>Profil</Link></li>
                                    <li onClick={() => setUserDrop(false)}><Link>Mənim sifarişlərim</Link></li>
